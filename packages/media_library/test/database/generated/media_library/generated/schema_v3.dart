...
class PlaybackHistoryEntries extends Table
    with TableInfo<PlaybackHistoryEntries, PlaybackHistoryEntriesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  PlaybackHistoryEntries(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> rowId = GeneratedColumn<int>(
    'row_id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {rowId};
  @override
  PlaybackHistoryEntriesData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return PlaybackHistoryEntriesData(
      rowId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}row_id'],
      )!,
  ...
  @override
  PlaybackHistoryEntries createAlias(String alias) {
    return PlaybackHistoryEntries(attachedDatabase, alias);
  }
...
class PlaybackHistoryEntriesData extends DataClass
    implements Insertable<PlaybackHistoryEntriesData> {
  final int rowId;
  final String publicId;
  final String playbackSessionId;
  final int trackId;
  final int startedAt;
  const PlaybackHistoryEntriesData({
    required this.rowId,
    required this.publicId,
  ...
  factory PlaybackHistoryEntriesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  PlaybackHistoryEntriesData copyWith({
    int? rowId,
    String? publicId,
    String? playbackSessionId,
    int? trackId,
    int? startedAt,
  }) => PlaybackHistoryEntriesData(
    rowId: rowId ?? this.rowId,
    publicId: publicId ?? this.publicId,
  ...
  PlaybackHistoryEntriesData copyWithCompanion(
    PlaybackHistoryEntriesCompanion data,
  ) {
    return PlaybackHistoryEntriesData(
      rowId: data.rowId.present ? data.rowId.value : this.rowId,
      publicId: data.publicId.present ? data.publicId.value : this.publicId,
  ...
  @override
  String toString() {
    return (StringBuffer('PlaybackHistoryEntriesData(')
          ..write('rowId: $rowId, ')
          ..write('publicId: $publicId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PlaybackHistoryEntriesData &&
          other.rowId == this.rowId &&
          other.publicId == this.publicId &&
...
class PlaybackHistoryEntriesCompanion
    extends UpdateCompanion<PlaybackHistoryEntriesData> {
  final Value<int> rowId;
  final Value<String> publicId;
  ...
  PlaybackHistoryEntriesCompanion.insert({
    ...
    required int startedAt,
       ...
       trackId = Value(trackId),
       startedAt = Value(startedAt);
  static Insertable<PlaybackHistoryEntriesData> custom({
    Expression<int>? rowId,
    Expression<String>? publicId,
...
class TrackPlaybackStats extends Table
    with TableInfo<TrackPlaybackStats, TrackPlaybackStatsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  TrackPlaybackStats(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> trackId = GeneratedColumn<int>(
    'track_id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> firstPlayedAt = GeneratedColumn<int>(
    'first_played_at',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  Set<GeneratedColumn> get $primaryKey => {trackId};
  @override
  TrackPlaybackStatsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TrackPlaybackStatsData(
      trackId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}track_id'],
      )!,
  ...
  @override
  TrackPlaybackStats createAlias(String alias) {
    return TrackPlaybackStats(attachedDatabase, alias);
  }
...
class TrackPlaybackStatsData extends DataClass
    implements Insertable<TrackPlaybackStatsData> {
  final int trackId;
  final int playCount;
  final int firstPlayedAt;
  final int lastPlayedAt;
  const TrackPlaybackStatsData({
    required this.trackId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['first_played_at'] = Variable<int>(firstPlayedAt);
  ...
  factory TrackPlaybackStatsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TrackPlaybackStatsData(
      ...
      firstPlayedAt: serializer.fromJson<int>(json['firstPlayedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'firstPlayedAt': serializer.toJson<int>(firstPlayedAt),
      'lastPlayedAt': serializer.toJson<int>(lastPlayedAt),
    };
  }

  TrackPlaybackStatsData copyWith({
    int? trackId,
    int? playCount,
    int? firstPlayedAt,
    int? lastPlayedAt,
  }) => TrackPlaybackStatsData(
    trackId: trackId ?? this.trackId,
    playCount: playCount ?? this.playCount,
    firstPlayedAt: firstPlayedAt ?? this.firstPlayedAt,
    lastPlayedAt: lastPlayedAt ?? this.lastPlayedAt,
  );
  TrackPlaybackStatsData copyWithCompanion(TrackPlaybackStatsCompanion data) {
    return TrackPlaybackStatsData(
      trackId: data.trackId.present ? data.trackId.value : this.trackId,
  ...
  @override
  String toString() {
    return (StringBuffer('TrackPlaybackStatsData(')
          ..write('trackId: $trackId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TrackPlaybackStatsData &&
          other.trackId == this.trackId &&
...
class TrackPlaybackStatsCompanion
    extends UpdateCompanion<TrackPlaybackStatsData> {
  final Value<int> trackId;
  final Value<int> playCount;
  final Value<int> firstPlayedAt;
  ...
  TrackPlaybackStatsCompanion.insert({
    ...
    required int firstPlayedAt,
    required int lastPlayedAt,
  }) : playCount = Value(playCount),
       firstPlayedAt = Value(firstPlayedAt),
       lastPlayedAt = Value(lastPlayedAt);
  static Insertable<TrackPlaybackStatsData> custom({
    Expression<int>? trackId,
    Expression<int>? playCount,
    Expression<int>? firstPlayedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (firstPlayedAt.present) {
      map['first_played_at'] = Variable<int>(firstPlayedAt.value);
    }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final PlaybackHistoryEntries playbackHistoryEntries =
      PlaybackHistoryEntries(this);
  late final TrackPlaybackStats trackPlaybackStats = TrackPlaybackStats(this);
